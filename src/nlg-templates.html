...
<dom-module id="nlg-templates">
  <template></template>
  <script>
    class NLGTemplates extends Polymer.Element {

      static get is() {
        return 'nlg-templates';
      }
      ...
      getSkeleton(width, height, viewBox, primaryFill, primaryOpacity, secondaryFill, secondaryOpacity, backgroundFill, backgroundOpacity, geometry) {
        return `
    ...
    window.customElements.define(NLGTemplates.is, NLGTemplates);
  </script>
</dom-module>
